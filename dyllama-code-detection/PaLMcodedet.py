...
aiplatform.init(project='learning-machine-425618', location='us-central1')

def get_completion(prompt):
# Define the endpoint and the model name
    endpoint = "projects/learning-machine-425618/locations/us-central1/publishers/google/models/text-bison@001"
    ...
    # Convert the instances to the proper format
    instances_value = Value()
    json_format.ParseDict({"instances": instances}, instances_value)

    # Call the model and get predictions
    response = client.predict(endpoint=endpoint, instances=[instances_value])
...
if __name__ == "__main__":
    root_directory = "./out"  # Set your source directory path here
    out_directory = "./reports"  # Set your output directory path here 
